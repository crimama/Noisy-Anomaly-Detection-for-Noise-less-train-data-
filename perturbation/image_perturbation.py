...
def motion_blur(x, severity=1):
    from perturbation.imagenet_c import corrupt
...
'''
org_img_folder='./coco-images-test/'
...
method_chunk = [clean,gaussian_noise,shot_noise,impulse_noise,speckle_noise,defocus_blur,glass_blur,zoom_blur,motion_blur,
                contrast,brightness,pixelate,elastic_transform,jpeg_compression]
...
class Perturbation(nn.Module):
    def __init__(self, method, severity:int = 2):
